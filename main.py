...
run = input_number('Введите пробег: ', 0, 999)
day = input_number('Введите сегодняшнее число: ', 1, 31)
sum_digits = sum(map(int, str(run)))  # применяю int для каждого знака строки
...
number_1 = input_number('Введите первое число: ', 0, 999999999999999999999)
number_2 = input_number('Введите второе число: ', 0, 999999999999999999999)
number_3 = input_number('Введите третье число: ', 0, 999999999999999999999)

res = max(number_1, number_2, number_3)
